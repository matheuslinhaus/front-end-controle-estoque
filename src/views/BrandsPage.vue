  ...
  export default {
    ...
    methods: {
      ...
      async submitCreateOrEdit() {
        try {
          if (this.formData.id) {
            await axios.put(`https://controle-estoque-eu4h.onrender.com/brands/${this.formData.id}`, this.formData);
          } else {
            await axios.post("https://controle-estoque-eu4h.onrender.com/brands", this.formData);
          }
          this.fetchBrands();
      ...
      async deleteBrand() {
        try {
          await axios.delete(`https://controle-estoque-eu4h.onrender.com/brands/${this.brandToDelete.id}`);
          this.fetchBrands();
